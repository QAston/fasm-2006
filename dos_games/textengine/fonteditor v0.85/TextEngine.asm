...
reset_bvideo:
	...
	mov	ecx,80*50*2
zeroize_buffer:
	;es:edi= adres bufora do wyzerowania
...
strncpy:
	;es:edi= adres docelowy ds:esi adres zrodlowy
...
SizeBuffer = 1+80*50*2+32h+36+258+66
...
virtual at BUFFER
	...
	OldMenuPos		dw	?
	Font			db	?,?,?,?,?,?,?,?
	ASCIIButtons: times 258 db	?
	FontButtons:  times 66	db	?
end virtual
