...
TFont:		db '             Anuluj [Esc]        Zatwierdü [F1]        UsuÒ [F2]',0
		db '[Pomoc]'
		db '1.G≥Ûwny ekran:'
THelp		db 'Na g≥ownym ekranie dostÍpne sπ nastÍpujπce funkcje:'
		db '-Funkcja "Zapisz" zapisuje tabelÍ czcionek do pliku "game.fnt".'
		db '-Funkcja "WyczyúÊ" usuwa wszystkie edytowane znaki z tabeli.'
		db '-Funkcja "Zalecane" ≥aduje do tabeli domyúlne czcionki'
		db '-Funkcja "Autor" wyswietla zasady licencji i ksywkÍ autora programu.'
		db '-Funkcja "Pomoc" wyswietla ten ekran'
		db 'Z do≥u g≥Ûwnego ekranu znajduje siÍ tabela z fontami.'
		db 'Kursorami i enterem moøna wybraÊ znak, ktÛry chce siÍ edytowaÊ lub utworzyÊ.'
		db '2.Ekran edycji:'
		db '-Na ekranie edycji dostÍpne sπ nastÍpujπce funkcje:'
		db '-Funkcja "Anuluj" przechodzi go g≥Ûwnego ekranu nie zachowujπc zmian'
		db '-Funkcja "Zatwierz" przechodzi do g≥Ûwnego ekranu zachowujπc zmieniony znak'
		db '-Funkcja "UsuÒ" przywraca domyúlny znak'
		db 'Na ekranie edycji moøna zaprojektowaÊ znak uøywajπc kursorÛw i entera'
		db '3.Co naleøy wiedzieÊ?'
		db '-Znaki domyúlne nie sπ przechowywane w pliku "game.fnt"'
		db '-Przy wejúciu do ekranu edycji ≥adowane sπ tylko znaki "Zalecane" i edytowane'
		db '-Bezpiecznie moøna zmieniaÊ znaki: 80-85,87-8C,8E,93,94,99,9A'
		db '-Na ekranie edycji moøna zastπpiÊ znak domyúlny utworzonym przez siebie.'
