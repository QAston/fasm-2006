...
FONTS:
NewFontPLS		   db	   'ó',8h,78h,0d4h,070h,038h,08ch,078h,0	;8c
NewFontPLZ		   db	   'ç',10h,0feh,0ach,098h,032h,066h,0feh,0	;8f
NewFontPLs		   db	   'ò',8h,10h,7ch,0c0h,078h,0ch,0f8h,0		;9c
NewFontPLz		   db	   '´',8h,10h,0fch,098h,030h,064h,0fch,0	;9f
NewFontPLL		   db	   'ù',0f0h,60h,60h,70h,0e2h,066h,0feh,0h	;a3
NewFontPLA		   db	   '§',30h,78h,0cch,0cch,0fch,0cch,0cch,6	;a5
NewFontPLZ2		   db	   'Ω',0feh,0c6h,8ch,07ch,032h,066h,0feh,0	;af
NewFontPLl		   db	   'à',70h,30h,30h,38h,70h,30h,78h,0h		;b3
NewFontPLa		   db	   '•',0h,0h,78h,0ch,07ch,0cch,7eh,0ch		;b9
NewFontPLz2		   db	   'æ',20h,0h,0fch,098h,030h,064h,0fch,0	;bf
NewFontPLC		   db	   'è',04,3ch,56h,0c0h,0c0h,066h,3ch,0		;c6
...
NewFontPLc		   db	   'Ü',8h,10h,78h,0cch,0c0h,0cch,78h,0		;e6
NewFontPLe		   db	   '©',0,0h,78h,0cch,0fch,0c0h,78h,0ch		;ea
