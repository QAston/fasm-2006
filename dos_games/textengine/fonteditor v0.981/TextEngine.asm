...
TProgramTitle:	db 'GreenT Text Game Reader Font Editor v 0.9.8.1',0
...
THelp:		db '[Pomoc]',10,13,10,10
		...
		db '-Aby przywr',Û,'ci',Ê,' kolory po wyj',ú,'ciu do Windows nale',ø,'y wcisn',π,Ê,' klawisz [c].',10,13
