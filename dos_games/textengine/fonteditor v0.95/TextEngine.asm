...
;tu ma byc pobieranie domyslnych fontow z VGA
...
.no_key:
	...
	int	33h				   ;bx:klawisze cx:kolumna8* dx:rzπd*8
	mov	ah,1ch
...
THelp:		db '[Pomoc]',10,13,10,10
		...
		db 'Kursorami i [Enter] moøna wybraÊ znak, ktÛry chce siÍ edytowaÊ.',10,13,10
		...
		db 'Na ekranie edycji moøna zaprojektowaÊ znak uøywajπc kursorÛw i [Enter]',10,13,10
		db '3.Uwaga!',10,13
...
SizeBuffer = 1+(80*50*2)+32h+28+(257*2)+(65*2)	;rozmiar zmiennych niezainicjowanych
