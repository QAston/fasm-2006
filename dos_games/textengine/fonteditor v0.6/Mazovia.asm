...
.fonts_changed:
	...
	int	21h
	mov	esi,[AFonts]
			    ;do esi adres pamieci z fontami
	call	change_fonts
...
TMessage	db 'Wybierz znak, kt¢ry chcesz zmieniç:',0
TMenu:		db 'Zapisz [F1] Wyczyûç [F2] Standardowe [F3] Autor [F4] Pomoc [F5] Wyjûcie [Esc]',0
Font		db 8h,10h,78h,0cch,0cch,0cch,78h,0h
...
NewFontPLS		   db	   'ò',8h,78h,0d4h,070h,038h,08ch,078h,0	;8c
NewFontPLZ		   db	   '†',10h,0feh,0ach,098h,032h,066h,0feh,0	;8f
NewFontPLs		   db	   'û',8h,10h,7ch,0c0h,078h,0ch,0f8h,0		;9c
NewFontPLz		   db	   '¶',8h,10h,0fch,098h,030h,064h,0fch,0	;9f
NewFontPLL		   db	   'ú',0f0h,60h,60h,70h,0e2h,066h,0feh,0h	;a3
NewFontPLA		   db	   'è',30h,78h,0cch,0cch,0fch,0cch,0cch,6	;a5
NewFontPLZ2		   db	   '°',0feh,0c6h,8ch,07ch,032h,066h,0feh,0	;af
NewFontPLl		   db	   'í',70h,30h,30h,38h,70h,30h,78h,0h		;b3
NewFontPLa		   db	   'Ü',0h,0h,78h,0ch,07ch,0cch,7eh,0ch		;b9
NewFontPLz2		   db	   'ß',20h,0h,0fch,098h,030h,064h,0fch,0	;bf
NewFontPLC		   db	   'ï',04,3ch,56h,0c0h,0c0h,066h,3ch,0		;c6
NewFontPLE		   db	   'ê',0feh,062h,68h,078h,068h,062h,0fch,06h	;ca
...
NewFontPLc		   db	   'ç',8h,10h,78h,0cch,0c0h,0cch,78h,0		;e6
NewFontPLe		   db	   'ë',0,0h,78h,0cch,0fch,0c0h,78h,0ch		;ea
NewFontPLn		   db	   '§',10h,20h,0f0h,0d8h,0d8h,0d8h,0d8h,0h	;fl
NewFontPLo		   db	   '¢',8h,10h,78h,0cch,0cch,0cch,78h,0h 	;f3
EndFontFile:		   db	   0ffh
