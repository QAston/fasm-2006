...
update_comp_anim_frame:
	...
	cmp	[esi+4],edx
	cmove	edx,eax
	mov	[ds:ebp+actualframe],edx
	mov	dword[ds:ebp+redrawframe],0
	ret
...
draw_comp_anim_frame:
	...
	mov	esi,[ds:ebp+animaddr]
	add	esi,4
	movzx	eax,byte[esi+5] 	   ;al-ustawienia
	ror	eax,16
;        test    eax,10000h
