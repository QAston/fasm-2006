...
show_tfcg_file:
	...
	animbuffer = 0;dd adres bufora animacji
	filehandle = 4;dd uchwyt pliku
	pozycja = 8;dw pozycja do wyswietlania
	kolordomyslny = 10 ;db kolor standardowy
	ustawienia = 11  ;db bit 0 0-redraw definiowany pierwszym bajtem 1-redraw za ka¿dym razem  bit 1-czy fps jest sta³y czy zmienny
	liczbaklatek = 12 ;dd
	rozmiar = 16
...
.file_present:
	...
	mov	ebx,[ebp-uchwyt]
	add	edx,4				  ;do ebx uchwyt do pliku
	mov	ecx,6
	mov	ax,3f00h
	int	21h

;sprawdzanie naglowka pliku
