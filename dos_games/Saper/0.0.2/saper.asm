...
MainMenuButtons:
db     4,1,78,48 or 10000000b,79,48 or 11000000b,78,49 or 00000000b,79,49 or 10000000b
Arrow:
db '=>',0
...
get_button:
	...
	mov	eax,ebx 			   ;zachowaj w gornej polowie ebx
	inc	ecx
...
show_buffer:
	...
	mov	edi,[GraphicCardAdress]   ; segment pamiëci obrazu
	mov	esi,BVideo
	mov	ecx,80*50*2
