...
mov ah,35h
int 21h
mov word[staryadres],bx
mov word[staryadres+2],es
mov al,09h
mov dx,scankeyboard
mov ah,25h
int 21h
...
mov dx,word[staryadres]
mov ds,word[staryadres+2]	     ; Move old INT 09H pointer to DS:DX
mov ah,25h
int 21h
pop ds
ret
