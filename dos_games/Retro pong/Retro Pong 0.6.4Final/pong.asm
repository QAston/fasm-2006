...
db 'ZASADY GRY'
db 10,13
db 'Po uruchomieniu gry widzimy dwie paletki, sciany i miejsce na punktacje',10,13,\
'I i II z prawej strony ekranu). Zadaniem graczy jest umieszczenie pileczki',10,13,\
'za paletka przeciwnika. Ten, kto pierwszy uczyni to 11 razy wygrywa',10,13,\
'Gracz, ktory zdobyl punkt ma dodana kropke w punktacji i serwuje pilke.',10,13,\
'Gdy wcisnie sie klawisz serwu nalezy wybrac kierunek lotu pilki.',10,13,'Milej zabawy!'
db 10,13
db 'STEROWANIE'
db 10,13
db '[Esc]- wyjscie'
